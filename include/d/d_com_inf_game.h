...
// See its comment (d_com_inf_game.cpp) for why VR call sites building an
// env-map matrix from fovy/aspect need this instead of dComIfGd_getView()'s
// fields directly.
DUSK_NOINLINE void dComIfGd_getReflectionFovAspect(f32* o_fovy, f32* o_aspect);
